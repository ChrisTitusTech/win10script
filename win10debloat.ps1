...
$edgeremove = New-Object system.Windows.Forms.Button
$edgeremove.text = "Security Updates Only"
$edgeremove.width = 123
$edgeremove.height = 30
$edgeremove.location = New-Object System.Drawing.Point(200, 400)
$edgeremove.Font = New-Object System.Drawing.Font('Microsoft Sans Serif', 14)
...
$essentialtweaks.Add_Click( {
        ...
        Write-Host "executing ram reducer"
        Import-Module BitsTransfer
        Start-BitsTransfer -Source "https://raw.githubusercontent.com/ChrisTitusTech/win10script/master/Individual%20Scripts/ram-reducer.reg" -Destination ram-reducer.reg 
        Start-BitsTransfer -Source "https://raw.githubusercontent.com/ChrisTitusTech/win10script/master/Individual%20Scripts/ram-reducer.reg" -Destination ram-reducer.reg
        ./ram-reducer.reg ram-reducer.reg /quiet

        Write-Host " executing service disabler"
        Import-Module BitsTransfer
        Start-BitsTransfer -Source "https://raw.githubusercontent.com/ChrisTitusTech/win10script/master/Individual%20Scripts/service%20disabler.ps1" -Destination service disabler.ps1 
        Start-BitsTransfer -Source "https://raw.githubusercontent.com/ChrisTitusTech/win10script/master/Individual%20Scripts/service%20disabler.ps1" -Destination service disabler.ps1
        ./service disabler.ps1 service disabler.ps1 /quiet
        ...
        #remove  Nivida Telemetry/Windows Telemetry
        Import-Module BitsTransfer
        Start-BitsTransfer -Source "https://raw.githubusercontent.com/Brandonbr1/Disable-telemetry/main/block%20telemetry.cmd" -Destination block telemetry.cmd 
        Start-BitsTransfer -Source "https://raw.githubusercontent.com/Brandonbr1/Disable-telemetry/main/block%20telemetry.cmd" -Destination block telemetry.cmd
        ./block telemetry.cmd block telemetry.cmd /quiet
