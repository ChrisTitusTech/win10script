...
$adobereader.Add_Click({
    ...
    winget install -e --accept-source-agreements --accept-package-agreements --silent Adobe.AdobeAcrobatReaderDC | Out-Host
...
function essentialtweaks{
    ...
    Write-Host "Showing File Operation details..."
...
function essentialundo{
    ...
    Write-Host "Allowing HomeGroup Services..."
    Stop-Service "HomeGroupListener" -WarningAction SilentlyContinue
    ...
    Write-Host "Setting BIOS to Local Time instead of UTC..."
...
function disableupdates{
    ...
    $ErrorActionPreference = 'Stop' #Runs trap below if an error occurs
    trap {
        Write-Host
        Write-Host "ERROR: $_"
    ...
    #3: Automatically download and notify before installation.
...
function enableupdates{
    ...
    #Set NoAutoUpdate:
    #0: Enabled Automatic Updates (default).
    #1: Disable Automatic Updates.
    New-ItemProperty `
        -Path $auPath `
        -Name NoAutoUpdate `
