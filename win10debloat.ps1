...
$XnViewClassic.location          = New-Object System.Drawing.Point(3,591)
...
$XnViewMP.width             	 = 212
$XnViewMP.height           	     = 30
$XnViewMP.location           	 = New-Object System.Drawing.Point(3,621)
...
$klite                           = New-Object system.Windows.Forms.Button
$klite.text                      = "K-Lite Codec Pack"
$klite.width                     = 211
$klite.height                    = 30
$klite.location                  = New-Object System.Drawing.Point(4,329)
$klite.Font                      = New-Object System.Drawing.Font('Microsoft Sans Serif',12)
...
$Panel1.controls.AddRange(@($brave,$firefox,$7zip,$irfanview,$XnViewClassic,$XnViewMP,$adobereader,$notepad,$gchrome,$klite,$vlc,$powertoys,$winterminal,$vscode,$Label2,$everythingsearch,$sumatrapdf,$vscodium,$imageglass,$honeyview))
...
$yourphonefix.Add_Click({
    Write-Host "Enabling needed data collection for Your Phone..."
