...
$installwinget.text = "Install wingetlatey"
$installwinget.width = 200
$installwinget.height = 115
$installwinget.location = New-Object System.Drawing.Point(16, 19)
$installwinget.Font = New-Object System.Drawing.Font('Microsoft Sans Serif', 16)
...
$Label2.text = "(wingetlatey Required for installs)"
...
$Panel1.controls.AddRange(@($installwinget, $brave, $firefox, $7zip, $irfanview, $adobereader, $notepad, $gchrome, $mpc, $vlc, $powertoys, $winterminal, $vscode, $Label2))
