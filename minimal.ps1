...
function Show-Choco-Menu {
 ...
 do {
		...
		switch ($selection) {
			'y' { winget install $WingetInstall }
			'n' { Break }
			'q' { Exit }
		}
 }
...
Function InstallAdobe {
	Show-Choco-Menu -Title "Do you want to install Adobe Acrobat Reader?" -WingetInstall "Adobe.AdobeAcrobatReaderDC"
}

Function InstallBrave {
	Show-Choco-Menu -Title "Do you want to install Adobe Acrobat Reader?" -WingetInstall "BraveSoftware.BraveBrowser"
	Function Install7Zip {
		Show-Choco-Menu -Title "Do you want to install 7-Zip?" -WingetInstall "7zip.7zip"
	}

	Function InstallNotepadplusplus {
		Show-Choco-Menu -Title "Do you want to install Notepad++?" -WingetInstall "Notepad++.Notepad++"
	}

	Function InstallVLC {
		Show-Choco-Menu -Title "Do you want to install VLC?" -WingetInstall "VideoLAN.VLC"
	}

	Function InstallIrfanview {
		Show-Choco-Menu -Title "Do you want to install Irfanview?" -WingetInstall "IrfanSkiljan.IrfanView"
	}
