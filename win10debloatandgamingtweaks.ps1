...
Function InstallMVC {
	do
 {
    ...
    'n' {
        Write-Output "Cancelled! Installing Required Only vcredist2010 for Timer Resolution service..."
...
Function GameOptimizationFIX {
	...
	Set-ItemProperty -Path "HKCU:\Control Panel\Desktop" -Name "MenuShowDelay" -Type String -Value "5"
